...
mu_d = 7.94 * 10 ** 22  # Магнитный момент диполя Земли (А*м^2) 
R_earth = 6.371 * 10 ** 6  # Радиус Земли (м) 
...
x_start = 10 * 6.371 * 10 ** 6  # Начальное положение по x (далеко от Земли)
y_offset = 0  # Смещение по оси y вправо
v_x = 299792458  # Скорость налета по x
